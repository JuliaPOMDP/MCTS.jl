...
BASELINE_RESULTS = "benchres_benchmarking-92ea2725_2024-04-16_16-42-56.json"
...
judgement =  BenchmarkTools.judge(median(new_results), median(baseline_results))
print_judgement(judgement)

println("\nComparing latest results to previous: \n\t$NEW_RESULTS\n\tto\n\t$PREVIOUS_RESULTS:")
judgement = BenchmarkTools.judge(median(new_results), median(previous_results))
print_judgement(judgement);
